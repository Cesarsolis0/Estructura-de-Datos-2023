...
def porcentaje_sintomas_iniciales(data):
    ...
    mylabels = ['Visual {:.2f}%'.format(lista_porcentajes[0]),
                'sensory {:.2f}%'.format(lista_porcentajes[1]),
                'motor {:.2f}%'.format(lista_porcentajes[2]),
                'other {:.2f}%'.format(lista_porcentajes[3]),
                'visual and sensory {:.2f}%'.format(lista_porcentajes[4]),
                'visual and motor {:.2f}%'.format(lista_porcentajes[5]),
                'visual and others {:.2f}%'.format(lista_porcentajes[6]),
                'sensory and motor {:.2f}%'.format(lista_porcentajes[7]), 
                'sensory and other {:.2f}%'.format(lista_porcentajes[8]), 
                'motor and other {:.2f}%'.format(lista_porcentajes[9]),
                'Visual, sensory and motor {:.2f}%'.format(lista_porcentajes[10]),
                'visual, sensory and other {:.2f}%'.format(lista_porcentajes[11]),
                'Visual, motor and other {:.2f}%'.format(lista_porcentajes[12]), 
                'Sensory, motor and other {:.2f}%'.format(lista_porcentajes[13]),
